...
sudo wget https://github.com/authnull0/windows-endpoint/raw/main/agent/radius-agent/authnull_2fa -O authnull_2fa || { echo -e "${RED}Failed to download authnull_2fa!${NC}"; exit 1; }
